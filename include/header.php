...
?>
    ...
    <div class="header-content container">
        ...
        <ul class="header-content-menu">
            ...
            <?php if (!isset($_SESSION['user'])): ?>
                <a href="" data-toggle="modal" data-target="#login">NHẬP MÃ KHUYẾN MÃI</a>
            <?php else: ?>
                <a href="nhapmakm.php?email=<?php echo urlencode($_SESSION['user']); ?>">NHẬP MÃ KHUYẾN MÃI</a>
            <?php endif; ?>
        ...
        <div class="row">
            <nav class="navbar navbar-dark ">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbar">
                    ...
                    <li><a href="payment.php">Thanh toán trực tuyến</a></li>
                    </ul>
                </div>
            </nav>
        </div>
