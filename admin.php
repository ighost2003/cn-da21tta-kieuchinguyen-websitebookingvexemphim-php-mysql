...
<div class="row">
    <div class="col-md-2" style="background:rgb(78,115,223);">
        <div class="container tabBarLeft">
            ...
            <a href="qltt.php" class="tabBarLeft-menu">
                <i class="fas fa-money-bill-wave"></i>
                <span class="tabBarLeft-menu-title">Quản lý thanh toán</span>
            </a>

            <a href="codekm.php" class="tabBarLeft-menu">
            <i class="fas fa-tags"></i>

                <span class="tabBarLeft-menu-title">Quản lý mã khuyến mãi</span>
            </a>

            <a href="themsuatchieu.php" class="tabBarLeft-menu">
            <i class='fas fa-edit'></i>

                <span class="tabBarLeft-menu-title">Thêm suất chiếu mới</span>
            </a>
